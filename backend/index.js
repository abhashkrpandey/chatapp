...
app.post("/chatdata", profileAuthentication, async (req, res) => {
    ...
    const chatdata = await ChatModel.find({ $or: [{ userid: userid, recepientid: recepientid }, { userid: recepientid, recepientid: userid }] }, { createdAt: 1, message: 1, _id: 1, userid: 1, recepientid: 1 }).lean();
